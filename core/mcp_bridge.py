"""
core/mcp_bridge.py — Intègre des serveurs MCP tiers dans le ToolRegistry.

Découvre les serveurs MCP locaux configurés dans mcp_config.json (filtrés par
mcp_activation_rules.json + mots-clés du prompt), les démarre en stdio et
enregistre leurs outils dans le ToolRegistry du moteur. Utilisé par main.py
et services/pipeline_service.py. S'auto-exclut de tab5-engine pour éviter
toute récursion.
"""
import asyncio
import json
