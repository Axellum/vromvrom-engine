"""
memory/context_manager.py — Compression sémantique des sorties d'outils volumineuses.

Résume via LM Studio local (fallback cloud DeepSeek) tout contenu dépassant
~10 Ko avant réinjection dans le contexte LLM, pour économiser des tokens.
Singleton avec ThreadPoolExecutor partagé. Consommé par tools/system.py
(read_file) et services/pipeline_service.py.
"""
import logging
