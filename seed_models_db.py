    ...
    providers = [
        {
            ...
            "type": "local",
            "api_endpoint": "http://192.168.0.84:1234/v1/chat/completions",
            "auth_method": "local",
...
def seed_models():
    ...
    models = [
        ...
        {"id": "qwen3-coder-next", "provider_id": "local", "display_name": "Qwen 3 Coder Next", "tier": "local", "routing_tier": "leger", "context_input": 131072, "context_output": 32768, "throughput_tps": 28.0, "supports_tools": 1, "speciality": "code", "recommended_use": "Génération de code local"},
        ...
        {"id": "gemma-4-31b", "provider_id": "local", "display_name": "Google Gemma 4 31B", "tier": "local", "routing_tier": "leger", "context_input": 131072, "context_output": 32768, "throughput_tps": 15.0, "speciality": "polyvalent", "recommended_use": "Modèle Google local dense"},
        ...
        {"id": "deepseek-coder-v2-lite", "provider_id": "local", "display_name": "DeepSeek Coder V2 Lite", "tier": "local", "routing_tier": "leger", "context_input": 131072, "context_output": 16384, "throughput_tps": 50.0, "speciality": "code_rapide", "recommended_use": "Code léger rapide"},
        ...
        {"id": "claude-sonnet-4.6-thinking-cli", "provider_id": "claude_cli", "display_name": "Claude Sonnet 4.6 Thinking CLI (legacy)", "tier": "subscription", "routing_tier": "moyen", "context_input": 200000, "context_output": 32768, "speciality": "pair_programming", "recommended_use": "Alias legacy → sonnet-4-6", "notes": "Alias legacy"},
        {"id": "claude-opus-4.6-thinking-cli", "provider_id": "claude_cli", "display_name": "Claude Opus 4.6 Thinking CLI (legacy)", "tier": "subscription", "routing_tier": "fort", "context_input": 200000, "context_output": 32768, "speciality": "architecture", "recommended_use": "Alias legacy → opus-4-8", "notes": "Alias legacy"},

        # ═══ MISTRAL (Free Experiment) ═══
        {"id": "mistral-large-latest", "provider_id": "mistral", "display_name": "Mistral Large (latest)", "tier": "free", "routing_tier": "moyen", "context_input": 128000, "context_output": 8192, "cost_input_per_m": 0.0, "cost_output_per_m": 0.0, "supports_tools": 1, "supports_vision": 1, "supports_json_mode": 1, "supports_streaming": 1, "speciality": "raisonnement", "recommended_use": "Raisonnement fort, RAG en français, Tool Calling", "notes": "Plan Experiment (Gratuit)"},
        {"id": "codestral-latest", "provider_id": "mistral", "display_name": "Codestral (latest)", "tier": "free", "routing_tier": "moyen", "context_input": 32000, "context_output": 8192, "cost_input_per_m": 0.0, "cost_output_per_m": 0.0, "supports_tools": 1, "supports_json_mode": 1, "supports_streaming": 1, "speciality": "code", "recommended_use": "Génération de code et FIM", "notes": "Plan Experiment (Gratuit)"},
        ...
        # ═══ CEREBRAS API ═══
        {"id": "gpt-oss-120b", "provider_id": "cerebras", "display_name": "GPT OSS 120B (Cerebras)", "tier": "paid", "routing_tier": "fort", "context_input": 8192, "context_output": 4096, "cost_input_per_m": 0.0, "cost_output_per_m": 0.0, "supports_tools": 1, "supports_json_mode": 1, "supports_streaming": 1, "speciality": "raisonnement", "recommended_use": "Modèle géant 120B ultra-rapide (Cerebras)", "notes": "Clé Payante (Cerebras)"},
        {"id": "gemma-4-31b-cerebras", "provider_id": "cerebras", "display_name": "Gemma 4 31B (Cerebras)", "tier": "paid", "routing_tier": "moyen", "context_input": 8192, "context_output": 4096, "cost_input_per_m": 0.0, "cost_output_per_m": 0.0, "supports_tools": 1, "supports_json_mode": 1, "supports_streaming": 1, "speciality": "ultra_rapide", "recommended_use": "Google Gemma 4 31B ultra-rapide (Cerebras Wafer Scale)", "notes": "Clé Payante (Cerebras)"},
        ...
        {"id": "deepseek-v4-flash", "provider_id": "deepseek", "display_name": "DeepSeek V4 Flash", "tier": "paid", "routing_tier": "moyen", "context_input": 1000000, "context_output": 65536, "cost_input_per_m": 0.14, "cost_output_per_m": 0.28, "cost_cached_per_m": 0.003, "supports_tools": 1, "supports_json_mode": 1, "supports_streaming": 1, "speciality": "agents_lowcost", "recommended_use": "Tâches de routine à très bas coût"},
        {"id": "deepseek-v4-pro", "provider_id": "deepseek", "display_name": "DeepSeek V4 Pro", "tier": "paid", "routing_tier": "fort", "context_input": 1000000, "context_output": 65536, "cost_input_per_m": 0.435, "cost_output_per_m": 0.87, "cost_cached_per_m": 0.004, "supports_thinking": 1, "supports_tools": 1, "supports_json_mode": 1, "supports_streaming": 1, "speciality": "raisonnement", "recommended_use": "Planification multi-étapes — tarif permanent (ex-promo)"},
        {"id": "deepseek-chat", "provider_id": "deepseek", "display_name": "DeepSeek Chat (alias V4 Flash)", "tier": "paid", "routing_tier": "leger", "context_input": 1000000, "context_output": 65536, "cost_input_per_m": 0.14, "cost_output_per_m": 0.28, "cost_cached_per_m": 0.003, "supports_tools": 1, "supports_json_mode": 1, "supports_streaming": 1, "speciality": "agents_lowcost", "recommended_use": "Alias legacy → redirige vers V4 Flash", "notes": "Alias legacy"},
        {"id": "deepseek-reasoner", "provider_id": "deepseek", "display_name": "DeepSeek Reasoner (legacy R1)", "tier": "paid", "routing_tier": "fort", "context_input": 1000000, "context_output": 65536, "cost_input_per_m": 0.55, "cost_output_per_m": 2.19, "cost_cached_per_m": 0.14, "supports_thinking": 1, "supports_json_mode": 1, "supports_streaming": 1, "speciality": "raisonnement", "recommended_use": "Legacy R1 — migration vers V4 recommandée", "notes": "Legacy R1"},
...
def seed_api_keys():
    ...
    keys = [
        ...
        {"id": "GEMINI_API_KEY_6", "provider_id": "gemini_free", "env_var": "GEMINI_API_KEY_6", "project_name": "moteur-ia-backup-5", "key_type": "free", "quota_rpm": 15, "quota_rpd": 500, "quota_tpm": 250000, "last_tested": "2026-07-05"},
        ...
        {"id": "CEREBRAS_PAYANT_API_KEY", "provider_id": "cerebras", "env_var": "CEREBRAS_PAYANT_API_KEY", "project_name": "Cerebras Paid Tier", "key_type": "paid", "quota_rpm": 60, "quota_rpd": None, "quota_tpm": 1000000, "last_tested": "2026-07-24"},
        ...
        # Coding Plan Lite : 1200 req / fenêtre 5h ≈ 4 RPM théorique ; on note le plafond 5h.
        {"id": "DASHSCOPE_API_KEY", "provider_id": "dashscope", "env_var": "DASHSCOPE_API_KEY", "project_name": "Alibaba Coding Plan Lite", "key_type": "subscription", "quota_rpm": 4, "quota_rpd": 600, "quota_tpm": None, "last_tested": "2026-07-26"},
    ]
...
def seed_access_channels():
    ...
    free_keys = ["GEMINI_API_KEY", "GEMINI_API_KEY_2", "GEMINI_API_KEY_3", "GEMINI_API_KEY_4", "GEMINI_API_KEY_5", "GEMINI_API_KEY_6"]
    free_models = [
    ...
    # Cerebras API → 3 modèles (Canal Payant + Canal Gratuit en secours)
    cerebras_models = [
        ("gpt-oss-120b", "gpt-oss-120b", 150, 450.0),
        ("gemma-4-31b-cerebras", "gemma-4-31b", 120, 500.0),
        ("zai-glm-4.7", "zai-glm-4.7", 100, 500.0),
    ]
    for model_id, alias, ttft, tps in cerebras_models:
        ok_paid = upsert_access_channel(
            model_id, "CEREBRAS_PAYANT_API_KEY",
            access_method="api_rest", provider_alias=alias,
            speed_tier="ultra_fast", latency_ttft_ms=ttft, throughput_tps=tps,
            is_default=1,
        )
        if ok_paid: count += 1
        ok_free = upsert_access_channel(
    ...
    # Alibaba DashScope Coding Plan Lite → 10 modèles (préfixe dashscope/)
    dashscope_models = [
        ("dashscope/qwen3.7-plus", "qwen3.7-plus", 800, 60.0),
        ("dashscope/qwen3.6-plus", "qwen3.6-plus", 800, 60.0),
        ("dashscope/qwen3.5-plus", "qwen3.5-plus", 800, 55.0),
        ("dashscope/qwen3-max-2026-01-23", "qwen3-max-2026-01-23", 1000, 45.0),
        ("dashscope/qwen3-coder-next", "qwen3-coder-next", 700, 70.0),
        ("dashscope/qwen3-coder-plus", "qwen3-coder-plus", 800, 55.0),
        ("dashscope/kimi-k2.5", "kimi-k2.5", 900, 50.0),
        ("dashscope/glm-5", "glm-5", 900, 50.0),
        ("dashscope/glm-4.7", "glm-4.7", 800, 55.0),
        ("dashscope/MiniMax-M2.5", "MiniMax-M2.5", 800, 55.0),
    ]
    for model_id, alias, ttft, tps in dashscope_models:
        ok = upsert_access_channel(
            model_id, "DASHSCOPE_API_KEY",
            access_method="api_rest", provider_alias=alias,
            speed_tier="fast", latency_ttft_ms=ttft, throughput_tps=tps,
            is_default=1 if model_id == "dashscope/qwen3-coder-next" else 0,
            notes="Coding Plan Lite — endpoint coding-intl, clé sk-sp-*",
        )
        if ok: count += 1
...
def seed_quota_realtime():
    ...
    quotas = [
        # 6 clés Gemini Free (15 RPM, 500 RPD, 250K TPM chacune)
        ...
        {"api_key_id": "GEMINI_API_KEY_6", "limit_rpm": 15, "limit_rpd": 500, "limit_tpm": 250000, "external_status": "ok"},
        ...
        # Cerebras API (Free + Paid)
        {"api_key_id": "CEREBRAS_API_KEY", "limit_rpm": 30, "limit_rpd": 14400, "limit_tpm": None, "external_status": "ok"},
        {"api_key_id": "CEREBRAS_PAYANT_API_KEY", "limit_rpm": 60, "limit_rpd": None, "limit_tpm": 1000000, "external_status": "ok"},
        # Alibaba Coding Plan Lite — 1200 req/5h (~4 RPM), ~600 RPD (18000/mois)
        {"api_key_id": "DASHSCOPE_API_KEY", "limit_rpm": 4, "limit_rpd": 600, "limit_tpm": None, "external_status": "ok"},
        # OpenRouter API (Free)
